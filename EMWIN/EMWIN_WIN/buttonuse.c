...
{
	{ FRAMEWIN_CreateIndirect, "Framewin", ID_FRAMEWIN_0, 0, 0, 128, 128, 0, 0x64, 0 },
	{ BUTTON_CreateIndirect, "Button", ID_BUTTON_0, 0, 10, 50, 50, 0, 0x0, 0 },
	{ BUTTON_CreateIndirect, "Button", ID_BUTTON_1, 0, 60, 50, 50, 0, 0x0, 0 },
};
...
static void _cbDialog(WM_MESSAGE * pMsg) 
{
	...
	switch (pMsg->MsgId) 
	{
		case WM_INIT_DIALOG:
			...
			BUTTON_SetFont(hItem, GUI_FONT_8_ASCII);
